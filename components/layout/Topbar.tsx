...
export function Topbar({
  ...
  return (
    <header className="sticky top-0 z-30 flex flex-wrap items-center justify-between gap-3 border-b border-gray-100 bg-white px-4 py-4 shadow-soft sm:px-6">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="hidden rounded-lg p-2 text-gray-500 transition-colors hover:bg-gray-100 md:inline-flex"
